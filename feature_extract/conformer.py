...
https://github.com/pengzhiliang/Conformer/blob/3a3db3644d85010ad64fafeaca27eaf23f6ca27e/conformer.py
Drop_path=0.1 default in the code
论文中推理的时候是logits相加而非概率/2
'''
...
class Conformer(nn.Module):
  ...
  def forward(self, x):
    ...
    # 1 stage
    x = self.conv_1(x_base, return_x_2=False) # [1, 256, 36, 200]
